...
contestRouter.post('/question', authinticated_1.default.main, (0, ErrorHandler_1.default)(contest_1.default.addNewQuestion));
//get contest question :
contestRouter.get('/question', (0, ErrorHandler_1.default)(contest_1.default.getQuestion));
